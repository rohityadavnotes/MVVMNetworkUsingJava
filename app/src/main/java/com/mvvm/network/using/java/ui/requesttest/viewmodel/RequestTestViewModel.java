package com.mvvm.network.using.java.ui.requesttest.viewmodel;
...
@HiltViewModel
public class RequestTestViewModel extends ViewModel {
    ...
    @Inject
    public RequestTestViewModel(@TeamAScore int defaultTeamAScore, @TeamBScore int defaultTeamBScore) {
